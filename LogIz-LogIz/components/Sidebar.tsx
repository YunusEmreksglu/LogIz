...
export default function Sidebar() {
  ...
  return (
    <div className={cn(
      ...
      {/* Navigation */}
      <nav className="flex-1 p-3 space-y-6 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-800">
          ...
          <AnimatePresence>
            {!isCollapsed && (
              ...
              >
                ...
                <div className="text-xs text-gray-500">Log collection active</div>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
