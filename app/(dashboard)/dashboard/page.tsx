  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Threat Map */}
        <ThreatMap threats={stats.threatLocations || []} />
      </div>

      {/* Additional Charts Row */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <ThreatsOverTimeChart data={stats.threatsOverTime} />
        {/* Removed SeverityHeatmap as it was not present in target project dependencies yet or I missed it.
            Check if SeverityHeatmap exists in LogIz/components/charts using list_dir later if needed.
            For now, formatting it out or I should check if it exists.
        */}
      </div>
