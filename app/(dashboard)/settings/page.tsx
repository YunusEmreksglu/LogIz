...
export default function SettingsPage() {
    ...
    const testConnection = async (type: 'database' | 'firewall' | 'ids') => {
    ...
    const TestButton = ({ type }: { type: 'database' | 'firewall' | 'ids' }) => {
            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        /* Removed explicit font-mono for mobile friendliness if any */
                        className="w-full px-4 py-2.5 rounded-xl bg-gray-800/50 border border-gray-700/50 text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500/50 text-sm font-mono"
                    />
                </div>
